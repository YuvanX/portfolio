      ...
      content: (
        <div className="font-space">
          <p className="text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Worked as a Frontend Developer while building Darth.ai using React.js as the framework
          </p>
